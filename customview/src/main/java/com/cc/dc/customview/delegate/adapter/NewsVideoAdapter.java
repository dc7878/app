...
public class NewsVideoAdapter extends AbsListItemAdapterDelegate<NewsVideoEntity, NewsEntity, NewsVideoAdapter.NormalViewHolder> {
    ...
    protected NormalViewHolder onCreateViewHolder(@NonNull ViewGroup parent) {
        return new NormalViewHolder(context, inflater.inflate(R.layout.item_list_test_player, parent, false));
    }
...
//            viewHolder.playerView.setVisibility(View.GONE);
    ...
    static class NormalViewHolder extends RecyclerView.ViewHolder {
        ...
        private NormalViewHolder(Context context, View itemView) {
            super(itemView);
            this.context = context;
        ...
        public void onClickPlay() {
            AliyunVodPlayerView surfaceView = new AliyunVodPlayerView(context);
            surfaceView.setBackgroundColor(context.getResources().getColor(R.color.alivc_blue));
            ViewGroup.LayoutParams params = new FrameLayout.LayoutParams(100, 100);
            surfaceView.setLayoutParams(params);
            layerPlayer.addView(surfaceView, 0, params);
        }
    }
}
